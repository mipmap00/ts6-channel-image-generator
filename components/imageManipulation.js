...
export const SPACER_HEIGHT = 48;
export const SPACER_BANNER_HEIGHT = 52;
export const CHANNEL_HEIGHT = 40;
export const CHANNEL_BANNER_HEIGHT = 44;
export const CHANNEL_BANNER_WIDTH = 462;
