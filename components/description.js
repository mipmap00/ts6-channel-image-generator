...
const Description = () => {
    return (
        <Container>
            ...
            <div className={'p'}>If you like the project you can buy me a beer 🍻 <DonateButtonStyled/> or contribute to
                the project
                on <a href="https://github.com/pitkes22/ts5-channel-image-generator" target={'_blank'}>GitHub (bug
                    reports are welcomed)</a> !
            </div>

            <div className={'p'}>
                &copy; 2020 - <a href="mailto:padampasam@gmail.com" target={'_blank'}>Peter Adam</a>
                <StyledGithubBadge/>
            </div>
        </Container>
    );
